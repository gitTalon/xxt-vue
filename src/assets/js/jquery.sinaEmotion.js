...
(function($){
	$.fn.SinaEmotion = function(target){
		...
		$(this).click(function(event){
			...
			$('#emotions').html('<div style="float:right;margin: 5px 10px;"><a href="javascript:void(0);" id="prev">&laquo;</a><a href="javascript:void(0);" id="next">&raquo;</a></div><div class="categorys"></div><div class="container"></div><div class="page"></div>');
		...
		function showEmotions(){
			...
			$('#emotions .container a').click(function(){
				...
				checkWords(".foot_text");
				$(".foot_text").focus().attr("readonly","readonly");
				//$('#emotions').remove();
			});
